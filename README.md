...
### Project Structure
```
├── annaliesesapplication1.xcodeproj  - it lets you create and modify Xcode projects from Ruby.      
│ 
├── annaliesesapplication1            - Application components folder
